    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('trialing', 'Trialing'), ('canceled', 'Canceled')], max_length=8)),
                ...
                ('subscription_type', models.CharField(choices=[('monthly', 'monthly'), ('sixmonths', 'Six Months'), ('annual', 'Annual')], max_length=9)),
